...
`timescale 1 ps / 1 ps
module monsopc_mm_interconnect_0 (
	...
	wire  [92:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> cpu_0_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                           // cpu_0_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [5:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> cpu_0_data_master_agent:rp_channel
	...
	wire  [92:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> cpu_0_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                       // cpu_0_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [5:0] rsp_mux_001_src_channel;                                                     // rsp_mux_001:src_channel -> cpu_0_instruction_master_agent:rp_channel
	...
	wire  [16:0] cpu_0_jtag_debug_module_agent_m0_address;                                    // cpu_0_jtag_debug_module_agent:m0_address -> cpu_0_jtag_debug_module_translator:uav_address
	...
	wire  [93:0] cpu_0_jtag_debug_module_agent_rf_source_data;                                // cpu_0_jtag_debug_module_agent:rf_source_data -> cpu_0_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [93:0] cpu_0_jtag_debug_module_agent_rsp_fifo_out_data;                             // cpu_0_jtag_debug_module_agent_rsp_fifo:out_data -> cpu_0_jtag_debug_module_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                       // cmd_mux_002:src_valid -> cpu_0_jtag_debug_module_agent:cp_valid
	wire  [92:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> cpu_0_jtag_debug_module_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                       // cpu_0_jtag_debug_module_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                     // cmd_mux_002:src_channel -> cpu_0_jtag_debug_module_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                               // cmd_mux_002:src_startofpacket -> cpu_0_jtag_debug_module_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                 // cmd_mux_002:src_endofpacket -> cpu_0_jtag_debug_module_agent:cp_endofpacket
	...
	wire  [93:0] sram_s1_agent_rf_source_data;                                                // sram_s1_agent:rf_source_data -> sram_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] sram_s1_agent_rsp_fifo_out_data;                                             // sram_s1_agent_rsp_fifo:out_data -> sram_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> sram_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                       // sram_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> sram_s1_agent:cp_channel
	...
	wire   [5:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> boutons_s1_agent:cp_channel
	...
	wire  [92:0] cpu_0_data_master_agent_cp_data;                                             // cpu_0_data_master_agent:cp_data -> router:sink_data
	...
	wire  [92:0] cpu_0_instruction_master_agent_cp_data;                                      // cpu_0_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire         cpu_0_jtag_debug_module_agent_rp_valid;                                      // cpu_0_jtag_debug_module_agent:rp_valid -> router_004:sink_valid
	wire  [92:0] cpu_0_jtag_debug_module_agent_rp_data;                                       // cpu_0_jtag_debug_module_agent:rp_data -> router_004:sink_data
	wire         cpu_0_jtag_debug_module_agent_rp_ready;                                      // router_004:sink_ready -> cpu_0_jtag_debug_module_agent:rp_ready
	wire         cpu_0_jtag_debug_module_agent_rp_startofpacket;                              // cpu_0_jtag_debug_module_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         cpu_0_jtag_debug_module_agent_rp_endofpacket;                                // cpu_0_jtag_debug_module_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [92:0] sram_s1_agent_rp_data;                                                       // sram_s1_agent:rp_data -> router_005:sink_data
	...
	wire         cpu_0_jtag_debug_module_agent_rdata_fifo_src_valid;                          // cpu_0_jtag_debug_module_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] cpu_0_jtag_debug_module_agent_rdata_fifo_src_data;                           // cpu_0_jtag_debug_module_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         cpu_0_jtag_debug_module_agent_rdata_fifo_src_ready;                          // avalon_st_adapter_002:in_0_ready -> cpu_0_jtag_debug_module_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                           // avalon_st_adapter_002:out_0_valid -> cpu_0_jtag_debug_module_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                            // avalon_st_adapter_002:out_0_data -> cpu_0_jtag_debug_module_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                           // cpu_0_jtag_debug_module_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                           // avalon_st_adapter_002:out_0_error -> cpu_0_jtag_debug_module_agent:rdata_fifo_sink_error
	...
	monsopc_mm_interconnect_0_router router (
	...
	monsopc_mm_interconnect_0_router_001 router_001 (
	...
	monsopc_mm_interconnect_0_router_002 router_002 (
	...
	monsopc_mm_interconnect_0_router_002 router_003 (
	...
	monsopc_mm_interconnect_0_router_004 router_004 (
	...
	monsopc_mm_interconnect_0_router_004 router_005 (
	...
	monsopc_mm_interconnect_0_router_002 router_006 (
	...
	monsopc_mm_interconnect_0_router_002 router_007 (
	...
	monsopc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (cpu_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	monsopc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (cpu_0_reset_n_reset_bridge_in_reset_reset),                // in_rst_0.reset
	...
	monsopc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                      // in_clk_0.clk
		.in_rst_0_reset (cpu_0_reset_n_reset_bridge_in_reset_reset),          // in_rst_0.reset
		.in_0_data      (cpu_0_jtag_debug_module_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (cpu_0_jtag_debug_module_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (cpu_0_jtag_debug_module_agent_rdata_fifo_src_ready), //         .ready
