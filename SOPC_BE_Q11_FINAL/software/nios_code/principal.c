...
#define   config_nmeaRX (unsigned int*)     AVALON_NMEA_RX_0_BASE
#define   synchro_nmeaRX (unsigned int*)	(AVALON_NMEA_RX_0_BASE + 4)
#define   centaine_nmeaRX (unsigned int*)	(AVALON_NMEA_RX_0_BASE + 8)
#define   dizaine_nmeaRX (unsigned int*)	(AVALON_NMEA_RX_0_BASE + 12)
#define   unite_nmeaRX (unsigned int*)	    (AVALON_NMEA_RX_0_BASE + 16)
